...
abstract class EOAInterface extends MultiSignerInterface {
  ...
  /// Exports the mnemonic phrase associated with the wallet.
  ///
  ...
  /// Exports the private key associated with the Ethereum account derived from the wallet using the specified [index].
  ///
  /// Parameters:
  /// - [index]: The index used to derive the Ethereum account.
  ///

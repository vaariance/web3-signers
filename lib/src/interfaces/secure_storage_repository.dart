...
abstract class SecureStorageRepository {
  ...
  /// ```
  Future<void> save(String key, String value, {StorageOptions? options});

  /// Saves a credential to the secure storage for a specified [SignerType].
  ///
  /// Parameters:
  ...
  /// ```
  Future<void> saveCredential(SignerType type, {StorageOptions? options});
  ...
  /// ```
  Future<String?> read(String key, {StorageOptions? options});
  ...
  /// ```
  Future<String?> readCredential(SignerType type, {StorageOptions? options});
  ...
  /// ```
  Future<void> update(String key, String value, {StorageOptions? options});
  ...
  /// ```
  Future<void> delete(String key, {StorageOptions? options});
}

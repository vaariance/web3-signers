...
#ifndef PIGEON_PLATFORM_SIGNER_API_G_H_
#define PIGEON_PLATFORM_SIGNER_API_G_H_
...
template<class T> class ErrorOr {
 ...
 private:
  friend class PlatformSignerApi;
  ErrorOr() = default;
...
class PlatformSignerApi {
 public:
  PlatformSignerApi(const PlatformSignerApi&) = delete;
  PlatformSignerApi& operator=(const PlatformSignerApi&) = delete;
  virtual ~PlatformSignerApi() {}
 ...
 protected:
  PlatformSignerApi() = default;
};
}  // namespace web3_signers
#endif  // PIGEON_PLATFORM_SIGNER_API_G_H_
